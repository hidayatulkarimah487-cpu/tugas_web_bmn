...
<div class="hero-card mb-4">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 position-relative" style="z-index: 1;">
        <div>
            ...
            <p class="hero-subtitle">Masukkan data aset baru secara lengkap agar inventaris lebih rapi dan mudah dipantau.</p>
        </div>
...
<div class="form-card">
    <div class="card-topbar">
        ...
        <p class="text-muted mb-0">Pastikan kode aset tidak sama dengan data lain.</p>
    </div>

    <div class="card-body-custom">
        <form action="{{ route('aset-bmn.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="kategori_barang" class="form-select @error('kategori_barang') is-invalid @enderror">
                        ...
                        <option value="Mebel" {{ old('kategori_barang') == 'Mebel' ? 'selected' : '' }}>Mebel</option>
